...
var carouselElems = document.querySelectorAll('.carousel.top_carousel');
     M.Carousel.init(carouselElems, {fullWidth:true,
        indicators:true,
        onCycleTo: function () {
 ...
 M.Carousel.init(galleryItems, {})
    ...
    setInterval(function () {
        ...
        var elemsFloatingActionButton = document.querySelectorAll('.fixed-action-btn');
         M.FloatingActionButton.init(elemsFloatingActionButton, {});
         ...
         M.toast({html: 'نظر شما با موفقیت ثبت شد!',classes:'green lighten-1 '})
